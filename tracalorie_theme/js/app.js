...
//       meals = mealsData.map(
//         (mealData) => new Meal(mealData.name, mealData.calories, mealData.id)
//       );
//     }
//     return meals;
//   }
...
//         (workoutData) =>
//           new Workout(workoutData.name, workoutData.calories, workoutData.id)
//       );
//     }
//     return workouts;
//   }
      ...
      return meals
        .filter(
          (mealData) =>
            ...
            "name" in mealData &&
            "calories" in mealData
        )
        .map(
          (mealData) =>
            new Meal(mealData.name, Number(mealData.calories), mealData.id)
        );
    } catch (error) {
      ...
      return workouts
        .filter(
          (workoutData) =>
            ...
            "name" in workoutData &&
            "calories" in workoutData
        )
        .map(
          (workoutData) =>
            new Workout(
              workoutData.name,
              Number(workoutData.calories),
              workoutData.id
            )
        );
    } catch (error) {
